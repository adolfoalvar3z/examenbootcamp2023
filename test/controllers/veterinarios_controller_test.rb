...
class VeterinariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinario" do
    assert_difference("Veterinario.count") do
      post veterinarios_url, params: { veterinario: { apellido: @veterinario.apellido, especialidad: @veterinario.especialidad, nombre: @veterinario.nombre } }
    end
  ...
  test "should update veterinario" do
    patch veterinario_url(@veterinario), params: { veterinario: { apellido: @veterinario.apellido, especialidad: @veterinario.especialidad, nombre: @veterinario.nombre } }
